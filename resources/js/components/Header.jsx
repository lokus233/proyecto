       ...
       if (usuario) {
           Logeo = (
               <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', flex: '0 1 auto' }}>
                   ...
                   <div style={{ position: 'relative' }}>
                       <span
                           style={{ ...nombreUsuario, cursor: 'pointer' }}
                       ...
                       {usuarioAbierto && (
                           <div style={dropdown}>
                               <Link href="/mis-pedidos" style={enlaceDropdown} onClick={() => setUsuarioAbierto(false)}>Mis pedidos</Link>
                               <Link href="/perfil" style={enlaceDropdown} onClick={() => setUsuarioAbierto(false)}>Perfil</Link>
                           </div>
                       )}
                   </div>
