...
export default function AdminPlatosEdit({ plato, categorias }) {
   ...
   //inicializa con los valores actuales del plato

   const handleChange = (e) => {
       setDatos({ ...datos, [e.target.name]: e.target.value });
   };
   //Actualiza solo el campo que cambia


   const handleSubmit = (e) => {
       e.preventDefault();
       router.post(`/platos/${plato.id}`, { ...datos, _method: 'PUT' }, {
           forceFormData: true,
       });
   };
   //Envía solo lo que se haya cambiado.
           ...
           <div style={caja}>
               ...
               <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.2rem' }}>
                   ...
                   <div>
                       ...
                       <input name="prec   io" type="number" step="0.01" value={datos.precio} onChange={handleChange} required style={input} />
                   </div>
